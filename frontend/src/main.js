...
pluralCaseList.push( {plural: "hybridCloudServices", pascal: "HybridCloudService"} )

pluralCaseList.push( {plural: "cloudServiceIntegrations", pascal: "CloudServiceIntegration"} )

pluralCaseList.push( {plural: "securityPolicies", pascal: "SecurityPolicy"} )

pluralCaseList.push( {plural: "customers", pascal: "Customer"} )

pluralCaseList.push( {plural: "supportTickets", pascal: "SupportTicket"} )
