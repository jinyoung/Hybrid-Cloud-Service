<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="CustomerPhone" v-model="item.customerPhone" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="CustomerCompany" v-model="item.customerCompany" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
