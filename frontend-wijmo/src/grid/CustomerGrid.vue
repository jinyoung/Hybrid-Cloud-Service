<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['customerId','customerName','customerEmail','customerPhone','customerCompany',]" />
            ...
            <wj-flex-grid-column binding="customerName" header="customerName" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="customerEmail" header="customerEmail" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="customerPhone" header="customerPhone" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="customerCompany" header="customerCompany" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.customer.href;
